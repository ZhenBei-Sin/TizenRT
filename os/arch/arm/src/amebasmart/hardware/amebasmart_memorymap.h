...
#ifdef CONFIG_RUNFROMDDRRAM
#define AMEBASMART_DRAM_OFFSET         0x001E9000
#else
...
// Starting base from PSRAM for BL33 (0x60100000) but for IN DDR RAM case BL33 (0x601E9000)
#define AMEBASMART_DRAM_PBASE          (AMEBASMART_DRAM_PSECTION + AMEBASMART_DRAM_OFFSET)
#define AMEBASMART_DRAM_VBASE          (AMEBASMART_DRAM_VSECTION + AMEBASMART_DRAM_OFFSET)
